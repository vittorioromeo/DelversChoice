...
namespace example_ddl
{
    namespace TblUser_
    {
        ...
        struct Username
        {
            ...
            using _traits =
                sqlpp::make_traits<sqlpp::varchar, sqlpp::tag::require_insert>;
        };
        struct PwdHash
        {
            struct _alias_t
    ...
    struct TblUser : sqlpp::table_t<TblUser, TblUser_::Id, TblUser_::Username,
                         TblUser_::PwdHash>
    {
        struct _alias_t
        {
    ...
    struct TblChannel : sqlpp::table_t<TblChannel, TblChannel_::Id,
                            TblChannel_::Name, TblChannel_::IdUser>
    {
        struct _alias_t
        {
    ...
    struct TblUserChannel
        : sqlpp::table_t<TblUserChannel, TblUserChannel_::Id,
              TblUserChannel_::IdUser, TblUserChannel_::IdChannel>
    {
        struct _alias_t
        {
    ...
    struct TblMessage
        : sqlpp::table_t<TblMessage, TblMessage_::Id, TblMessage_::Contents,
              TblMessage_::IdUser, TblMessage_::IdChannel>
    {
        struct _alias_t
        {
