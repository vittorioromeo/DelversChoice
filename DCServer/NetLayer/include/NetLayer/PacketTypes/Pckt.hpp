...
namespace nl
{
    namespace Impl
    {
        ...
        struct PcktType
        {
            ...
            SSVU_ASSERT_STATIC(Impl::IsPcktIDType<TPcktIDType>{},
                "TPcktIDType must be a PcktIDType");
        ...
        struct PcktManager
        {
            SSVU_ASSERT_STATIC(Impl::IsPcktTypes<TPcktTypes>{},
                "TPcktTypes must be a PcktTypes");
