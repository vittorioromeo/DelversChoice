...
private:
    ...
    txtDeath{mkTxtOBBig()}, txtLog{mkTxtOBSmall()}, txtMode{mkTxtOBSmall()};

    ssvs::BitmapTextRich txtCredits{*getAssets().fontObStroked},
    txtRestart{*getAssets().fontObStroked}, txtMenu{*getAssets().fontObStroked},
    ...
    {
        static auto array(
        ssvu::mkArray("Beginner mode", "Official mode", "Hardcore mode"));
    ...
    inline void drawDead()
    {
        ...
        txtDeath.setColor(sf::Color(
        255, 255, 255, 255 - ssvu::toNum<unsigned char>(gs.deathTextTime)));
    }
