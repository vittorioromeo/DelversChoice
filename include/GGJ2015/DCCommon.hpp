...
namespace ggj
{
    ...
    struct GameData
    {
        ...
        inline float getRndDropValue()
        {
            auto mean(difficulty);
            return getRndR(
                       mean, mean * (meanDeviationRatio * dropDeviationMult)) *
                   dropValueMult;
        }
...
SSVJ_CNV_OBJ_AUTO(ggj::GameData, timerEnabled, timerMax, valueHPS, valueATK,
    valueDEF, difficulty, difficultyInc, difficultyEnemyMult,
    rndRangeMultiplier, meanDeviationRatio, section1, section2, section3,
    section4, section0ChoiceCount, section1ChoiceCount, section2ChoiceCount,
    section3ChoiceCount, section4ChoiceCount, choiceChanceCreature,
    choiceChanceSingleDrop, choiceChanceMultipleDrop, dropDeviationMult,
    dropValueMult, multipleDropChance, dropChanceIE, dropChanceWeapon,
    dropChanceArmor, multipleIEChance)
