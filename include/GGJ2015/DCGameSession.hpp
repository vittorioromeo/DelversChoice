...
struct GameSession
{
    ...
    {
        return mkShuffledVector<InstantEffect::Stat>(InstantEffect::Stat::SHPS,
        InstantEffect::Stat::SATK, InstantEffect::Stat::SDEF);
    }
    ...
    inline Creature generateCreature(bool mEnemy)
    {
        ...
        auto bucket(
        ssvu::mkArray(ssvu::getRndR(0, 3.f), ssvu::getRndR(0, 3.f), 0.f, 3.f));
