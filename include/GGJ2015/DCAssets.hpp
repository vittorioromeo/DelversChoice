    ...
    namespace Impl
    {
        struct Assets
        {
            ...
            CACHE_ASSETS(sf::Texture, ".png", slotChoice, slotChoiceBlocked,
                iconHPS, iconATK, iconDEF, drops, enemy, blocked, back,
                dropsModal, advance, itemCard, eFire, eWater, eEarth,
                eLightning, eST, eWK, eTY, equipCard, wpnMace, wpnSword,
                wpnSpear, armDrop, panelsmall, panellog)
